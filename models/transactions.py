...
def sendMoney(nombreUsuario):
    ...
    #! Modificado para que funcione solo con un parámetro
...
numeroTransaccion = registerTransaction(nombreUsuario, tipoTransaccion, monto, fecha, totalTransacciones)
totalTransacciones += 1
...
showTransactionsByType(nombreUsuario, transacciones)
print(checkTotalUserTransactions(nombreUsuario, transacciones))
